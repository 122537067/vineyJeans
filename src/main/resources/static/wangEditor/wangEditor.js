...
// 原型
    UploadVideo.prototype = {
        ...
        insertLinkVideo:function(link){
            ...
            editor.cmd.do('insertHTML', '<div><video src="' + link + '" style="width:50%;height: 50%;" controls autobuffer muted/></div>');
        ...
        uploadVideo: function uploadVideo(files) {
            ...
            var editor = this.editor;
            var config = editor.config;
            var uploadVideoServer = "/util/wangEditorUploadVideo/";//上传地址
